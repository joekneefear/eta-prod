#!/usr/bin/env perl_db
# SVN $Id: fcs_eagle_log_IFF.pl 2239 2017-11-02 00:55:18Z dpower $
...
unless (
    GetOptions(
        \%hOptions,  "OUT=s", "SITE=s", "LOC=s", "FINALLOT", "V", "CONFIG=s",
...
unless ( grep { $_ eq $site } qw/cpft szrel szft pmft me_rel meft aic_my_ft atec_ph_ft etrend_tw_ft hana_th_ft gtk_tw_ft utac_th_ft mtsort pmsort caft casort cpsort szsort slsort mesort bksort amkor_tw_csp isti_tw_csp its_tw_ft gtk_tw_sort vgrd_tw_sort cprel its_tw_ft/ ) {
