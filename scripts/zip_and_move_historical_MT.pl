...
use File::Spec;
{
    my @sourcedirs = ('/archives-yms/data/bkfb8_wks2/historical_wait/PRODUCTION', '/archives-yms/data/bkfb8_wks2/historical_wait/SANDBOX');
    my @destdirs   = ('/archives-yms/data/bkfb8_wks2/historical/PRODUCTION', '/archives-yms/data/bkfb8_wks2/historical/SANDBOX');
    my $maxfiles  = 1000;
    my $maxsize = 10000000;
...
sub start_new_archive {
    ...
    my $fn = "bkfb8_wks_" . $count . "_" . $date . ".zip";
