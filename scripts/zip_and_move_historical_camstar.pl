...
use File::Spec;
{
    my @sourcedirs = ('/archives-yms/data/cpast_camstar2/historical_wait/PRODUCTION', '/archives-yms/data/cpast_camstar2/historical_wait/SANDBOX');
    my @destdirs   = ('/archives-yms/data/cpast_camstar2/historical/PRODUCTION', '/archives-yms/data/cpast_camstar2/historical/SANDBOX');
    my $maxfiles  = 1000;
    my $maxsize = 10000000;
...
sub start_new_archive {
    ...
    my $fn = "cpast_camstar_" . $count . "_" . $date . ".zip";
