...
=head1 SYNOPSIS
  ...
  fcs_mavpt_txt_IFF.pl <Input flie name>
	--out <output dir>
...
=head1 CHANGES
 ...
 2016/Sep/19 eric : create
 2016/Oct/07 eric : append test code to TP
 2016/Oct/10 eric : load rework codes
 2017/Apr/21 jgarcia : modify to log and exit if Zero part tested;
...
unless (
    GetOptions( \%hOptions, "OUT=s",  "LOC=s", "SITE=s", "FINALLOT","LOGFILE=s", "DEBUG", "TRACE", "V", "PPLOG" )
    )
{
