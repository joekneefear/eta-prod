...
print "<div>Restoring selected file/s</div>";
print '<div id="searching"> <img id="loading-image" style="padding-left:175px;" src="../images/spinner.gif" alt="Restoring file from archive..." /> </div>';
...
my $reload_time   = "";
my $email_to      = "yms.admins\@onsemi.com";
