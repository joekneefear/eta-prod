...
if ($refresh_page eq "Y" && $monit_lotids ne "")
{
	...
	### SET PAGE STATUS ###
	$page_status = "RESTORE PROCESS IS ONGOING. PLEASE WAIT <br> <img src='../images/epi.gif' alt=Monitoring file to restore... />";
}
...
print "<script>",
      ...
      #{}"document.getElementById('status2').innerHTML=\"<img id=loading-image src='../images/epi.gif' alt=Monitoring file to restore... />\"",
      "</script>";
