#!/usr/bin/env perl_db
# SVN $Id: fcs_qtec_xlsx_sum_IFF.pl 
=pod

=head1 SYNOPSIS

      fcs_qtec_xlsx_sum_IFF.pl <Input flie name>
...
unless (
    GetOptions(
        \%hOptions,  "OUT=s", "FINALLOT", "SITE=s",
